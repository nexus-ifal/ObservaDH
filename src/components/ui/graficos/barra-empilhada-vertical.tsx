...
> = ({ dados }) => {
	return (
		<Card className="flex flex-col items-center justify-center w-[21.875rem] h-[16.25rem] tab:w-[45rem] tab:h-[25rem] des:w-[52rem] des:h-[29rem] bg-[#121A2B]  border-white ">
