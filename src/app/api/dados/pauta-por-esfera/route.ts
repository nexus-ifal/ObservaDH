...
import { ListarPautasPorEsferaController } from "@/adapters/api/controllers/dados/pautas-esfera-controller";
...
export async function GET(request: Request) {
	try {
		...
		const controller = new ListarPautasPorEsferaController();
