...
const Page: React.FC = () => {
	const { createPauta, isLoading, isSucess, error } = usePautaCreate();
	...
	return (
		<div className="text-white p-8 flex flex-col gap-8">
			...
			<AlertDialog open={showSuccess} onOpenChange={setShowSuccess}>
				...
				>
					<AlertDialogHeader>
						<AlertDialogTitle>Pauta cadastrada com sucesso</AlertDialogTitle>
				...
				<AlertDialogContent className="bg-red-600 text-white">
					<AlertDialogHeader>
						<AlertDialogTitle className={oswald.className}>
							{typeof error === "string"
								? error
								: error?.message || "Erro ao cadastrar pauta"}
						</AlertDialogTitle>
					</AlertDialogHeader>
					<AlertDialogFooter>
