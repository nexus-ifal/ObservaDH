								...
								render={({ field, fieldState }) => (
									<FormItem>
										...
										<FormControl>
											<Input
												{...field}
												className={`bg-white text-black h-12 w-full text-xl font-normal rounded-sm uppercase ${
													fieldState.error
														? "border-2 border-red-500 focus:border-red-500"
														: "border-2 border-[#91ADF4]"
												}`}
										...
										<FormItem className="h-full flex flex-col">
											...
											<FormControl>
												<Textarea
													{...field}
													rows={8}
													className="bg-white text-black w-full text-xl font-normal rounded-sm border-2 border-[#91ADF4] resize-y h-full min-h-[140px] max-h-80 overflow-auto"
