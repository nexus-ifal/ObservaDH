...
export class ListarIdeologiaGeneroService implements IListarIdeologiaGeneroService {
    async executar() {
        ...
        try {
            ...
            const agrupamento: Record<string, { homens: number; mulheres: number; ideologia: string }> = {};
            for (const ideologia of ideologiasFixas) {
                agrupamento[ideologia] = { homens: 0, mulheres: 0, ideologia };
            }
            agrupamento["Desconhecida"] = { homens: 0, mulheres: 0, ideologia: "Desconhecida" };
            ...
            for (const politico of politicos) {
                ...
                const ideologiaFinal = mapaIdeologias[ideologiaNormalizada] || "Desconhecida";
            ...
            // Troca o traço por espaço apenas na resposta final
